  ...
  <div>
    ...
    <Grid columns={2} divided>
      ...
      <Link to="/ProfilGüncelle">
        <li>
          <Button content="Güncelle" icon="right arrow" labelPosition="right" />
        </li>
      </Link>
    </Grid>
  </div>
